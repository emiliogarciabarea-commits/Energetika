...
def generar_pdf(df_detalle, df_ranking, df_consumos, nombre_cliente, direccion_cliente, compania_actual_manual):
    try:
        ...
        # --- BLOQUE CENTRADO CORREGIDO ---
        pdf.set_font('Arial', 'B', 18) # Aumentado un poco para dar énfasis
        pdf.set_text_color(20, 50, 100)
        # Usamos multi_cell con ancho 0 para que use todo el ancho de la página y centre de verdad
        pdf.multi_cell(0, 15, f"{str(nombre_ganadora).upper()}", align='C')
