...
def generar_pdf(df_detalle, df_ranking, df_consumos, nombre_cliente, direccion_cliente, compania_actual_manual):
    try:
        ...
        # --- PROCESAMIENTO PREVIO DE DATOS PARA PORTADA ---
        ...
        # --- AJUSTE SOLICITADO: SEPARACIÓN ENTRE TABLA Y GRÁFICA ---
        pdf.ln(15) 
        ...
        labels, values, colors_pie = ['Potencia (Fijo)', 'Energía (Consumo)'], [total_potencia, total_energia], ['#A9CCE3', '#ABEBC6']
        ...
        ax_pie.axis('equal'); plt.tight_layout()
        pie_path = "temp_pie.png"
        fig_pie.savefig(pie_path, dpi=300); plt.close(fig_pie)
        ...
        pdf.set_x(35)
        pdf.set_fill_color(20, 50, 100); pdf.set_text_color(255)
        ...
        pdf.set_x(20); pdf.set_font('Arial', 'B', 12); pdf.set_text_color(20, 50, 100); pdf.cell(170, 10, f"{str(nombre_ganadora).upper()}", border='LR', ln=True, align='C')
